...
return applyScreenSizePerspectiveScaleFactorVec2(size, screenSizePerspectiveScaleFactor(absCosAngle, distanceToCamera, params));
    ...
    `)):c.code.add(r`vec3 addVerticalOffset(vec3 worldPos, vec3 localOrigin) { return worldPos; }`)}const u=d();function O(e){e.uniforms.add(new z("verticalOffset",(a,c)=>{const{minWorldLength:s,maxWorldLength:i,screenLength:l}=a.verticalOffset,n=Math.tan(.5*c.camera.fovY)/(.5*c.camera.fullViewport[3]),f=c.camera.pixelRatio||1;return v(u,l*f,n,s,i)}))}export{$ as a,O as f,g as o,P as s,y as t};
