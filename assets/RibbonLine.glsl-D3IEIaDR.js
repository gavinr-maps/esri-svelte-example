...
}`))}var te;(function(i){i[i.BUTT=0]="BUTT",i[i.SQUARE=1]="SQUARE",i[i.ROUND=2]="ROUND",i[i.COUNT=3]="COUNT"})(te||(te={}));class _ extends gt{constructor(){super(...arguments),this.capType=te.BUTT,this.hasPolygonOffset=!1,this.writeDepth=!1,this.draped=!1,this.stippleEnabled=!1,this.stippleOffColorEnabled=!1,this.stipplePreferContinuous=!0,this.roundJoins=!1,this.applyMarkerOffset=!1,this.vvSize=!1,this.vvColor=!1,this.vvOpacity=!1,this.falloffEnabled=!1,this.innerColorEnabled=!1,this.hasOccludees=!1,this.occluder=!1,this.terrainDepthTest=!1,this.cullAboveTerrain=!1,this.wireframe=!1,this.discardInvisibleFragments=!1,this.objectAndLayerIdColorInstanced=!1,this.textureCoordinateType=St.None,this.emissionSource=Tt.None,this.occlusionPass=!1,this.hasVvInstancing=!0,this.hasSliceTranslatedView=!0}}f([v({count:te.COUNT})],_.prototype,"capType",void 0),f([v()],_.prototype,"hasPolygonOffset",void 0),f([v()],_.prototype,"writeDepth",void 0),f([v()],_.prototype,"draped",void 0),f([v()],_.prototype,"stippleEnabled",void 0),f([v()],_.prototype,"stippleOffColorEnabled",void 0),f([v()],_.prototype,"stipplePreferContinuous",void 0),f([v()],_.prototype,"roundJoins",void 0),f([v()],_.prototype,"applyMarkerOffset",void 0),f([v()],_.prototype,"vvSize",void 0),f([v()],_.prototype,"vvColor",void 0),f([v()],_.prototype,"vvOpacity",void 0),f([v()],_.prototype,"falloffEnabled",void 0),f([v()],_.prototype,"innerColorEnabled",void 0),f([v()],_.prototype,"hasOccludees",void 0),f([v()],_.prototype,"occluder",void 0),f([v()],_.prototype,"terrainDepthTest",void 0),f([v()],_.prototype,"cullAboveTerrain",void 0),f([v()],_.prototype,"wireframe",void 0),f([v()],_.prototype,"discardInvisibleFragments",void 0),f([v()],_.prototype,"objectAndLayerIdColorInstanced",void 0);const ue=1;function Pt(i){const e=new Hi,{attributes:t,varyings:r,vertex:s,fragment:a}=e,{applyMarkerOffset:h,draped:d,output:n,capType:c,stippleEnabled:p,falloffEnabled:b,roundJoins:T,wireframe:E,innerColorEnabled:z}=i;e.include(Kt),e.include(Xi,i),e.include(ir,i),e.include(ei,i),e.include(ti,i);const A=h&&!d;A&&(s.uniforms.add(new Y("markerScale",m=>m.markerScale)),e.include(or,{space:ee.World})),ii(s,i),s.uniforms.add(new ji("inverseProjectionMatrix",m=>m.camera.inverseProjectionMatrix),new ri("nearFar",m=>m.camera.nearFar),new Y("miterLimit",m=>m.join!=="miter"?0:m.miterLimit),new ai("viewport",m=>m.camera.fullViewport)),s.constants.add("LARGE_HALF_FLOAT","float",65500),t.add(l.POSITION,"vec3"),t.add(l.PREVPOSITION,"vec3"),t.add(l.NEXTPOSITION,"vec3"),t.add(l.SUBDIVISIONFACTOR,"float"),t.add(l.UV0,"vec2"),r.add("vColor","vec4"),r.add("vpos","vec3"),r.add("vLineDistance","float"),r.add("vLineWidth","float");const j=p;j&&r.add("vLineSizeInv","float");const y=c===te.ROUND,S=p&&y,$=b||S;$&&r.add("vLineDistanceNorm","float"),y&&(r.add("vSegmentSDF","float"),r.add("vReverseSegmentSDF","float")),s.code.add(o`vec2 perpendicular(vec2 v) {
return vec2(v.y, -v.x);
}
...
if (isOutside && (displacementLen > miterLimit * lineWidth)) {`),T?s.main.add(o`
        ...
        float factor = ${p?o`min(1.0, subdivisionFactor * ${o.float((ue+2)/(ue+1))})`:o`subdivisionFactor`};
...
vReverseSegmentSDF = (isJoin && !isStartVertex) ? LARGE_HALF_FLOAT : (dot(pos.xy - segmentEnd, -segmentDir) * pos.w);`),p&&(d?s.uniforms.add(new Ve("worldToScreenRatio",m=>1/m.screenToPCSRatio)):s.main.add(o`vec3 segmentCenter = mix((nextPosition + position) * 0.5, (position + prevPosition) * 0.5, isEndVertex);
...
float segmentLengthPseudoScreen = segmentLengthRender * discreteWorldToScreenRatio;`),s.uniforms.add(new Y("stipplePatternPixelSize",m=>Dt(m))),s.main.add(o`float patternLength = lineSize * stipplePatternPixelSize;
...
discardByTerrainDepth();`),E?a.main.add(o`vec4 finalColor = vec4(1.0, 0.0, 1.0, 1.0);`):(y&&a.main.add(o`
      ...
      `):a.main.add(o`float stippleAlpha = getStippleAlpha();`),n!==se.ObjectAndLayerIdColor&&a.main.add(o`discardByStippleAlpha(stippleAlpha, ${o.float(pe)});`),a.uniforms.add(new je("intrinsicColor",m=>m.color)),a.main.add(o`vec4 color = intrinsicColor * vColor;`),z&&(a.uniforms.add(new je("innerColor",m=>m.innerColor??m.color),new Y("innerWidth",(m,D)=>m.innerWidth*D.camera.pixelRatio)),a.main.add(o`float distToInner = abs(vLineDistance * gl_FragCoord.w) - innerWidth;
float innerAA = clamp(0.5 - distToInner, 0.0, 1.0);
float innerAlpha = innerColor.a + color.a * (1.0 - innerColor.a);
color = mix(color, vec4(innerColor.rgb, innerAlpha), innerAA);`)),a.main.add(o`vec4 finalColor = blendStipple(color, stippleAlpha);`),b&&(a.uniforms.add(new Y("falloff",m=>m.falloff)),a.main.add(o`finalColor.a *= pow(max(0.0, 1.0 - abs(vLineDistanceNorm * gl_FragCoord.w)), falloff);`)),p||a.main.add(o`float featherStartDistance = max(vLineWidth - 2.0, 0.0);
float value = abs(vLineDistance) * gl_FragCoord.w;
float feather = (value - featherStartDistance) / (vLineWidth - featherStartDistance);
finalColor.a *= 1.0 - clamp(feather, 0.0, 1.0);`)),a.main.add(o`outputColorHighlightOID(finalColor, vpos);`),e}const nr=Object.freeze(Object.defineProperty({__proto__:null,build:Pt,ribbonlineNumRoundJoinSubdivisions:ue},Symbol.toStringTag,{value:"Module"}));class lr extends li{constructor(e,t){super(e,t,new ci(nr,()=>Mi(()=>Promise.resolve().then(()=>Sr),void 0,import.meta.url)),$t),this.primitiveType=t.wireframe?nt.LINES:nt.TRIANGLE_STRIP}_makePipelineState(e,t){const{oitPass:r,output:s,hasOccludees:a,hasPolygonOffset:h}=e,d=r===tt.NONE,n=r===tt.FrontFace;return be({blending:ce(s)?pi(r):null,depthTest:{func:di(r)},depthWrite:hi(e),drawBuffers:s===se.Depth?{buffers:[_e.NONE]}:mi(r,s),colorWrite:Pe,stencilWrite:a?it:null,stencilTest:a?t?rt:ui:null,polygonOffset:d||n?h?ht:null:fi})}initializePipeline(e){if(e.occluder){const t=e.hasPolygonOffset?ht:null;this._occluderPipelineTransparent=be({blending:lt,polygonOffset:t,depthTest:at,depthWrite:null,colorWrite:Pe,stencilWrite:null,stencilTest:vi,drawBuffers:e.output===se.Depth?{buffers:[_e.NONE]}:null}),this._occluderPipelineOpaque=be({blending:lt,polygonOffset:t,depthTest:at,depthWrite:null,colorWrite:Pe,stencilWrite:gi,stencilTest:Si,drawBuffers:e.output===se.Depth?{buffers:[_e.NONE]}:null}),this._occluderPipelineMaskWrite=be({blending:null,polygonOffset:t,depthTest:Ti,depthWrite:null,colorWrite:null,stencilWrite:it,stencilTest:rt,drawBuffers:e.output===se.Depth?{buffers:[_e.NONE]}:null})}return this._occludeePipeline=this._makePipelineState(e,!0),this._makePipelineState(e,!1)}getPipeline(e,t){if(e)return this._occludeePipeline;switch(t){case V.TRANSPARENT_OCCLUDER_MATERIAL:return this._occluderPipelineTransparent??super.getPipeline();case V.OCCLUDER_MATERIAL:return this._occluderPipelineOpaque??super.getPipeline();default:return this._occluderPipelineMaskWrite??super.getPipeline()}}}const ht={factor:0,units:-4},$t=new Map([[l.POSITION,0],[l.PREVPOSITION,1],[l.NEXTPOSITION,2],[l.SUBDIVISIONFACTOR,3],[l.UV0,4],[l.COLOR,5],[l.COLORFEATUREATTRIBUTE,5],[l.SIZE,6],[l.SIZEFEATUREATTRIBUTE,6],[l.OPACITYFEATUREATTRIBUTE,7],[l.OBJECTANDLAYERIDCOLOR,8]]);var I;(function(i){i[i.LEFT_JOIN_START=-2]="LEFT_JOIN_START",i[i.LEFT_JOIN_END=-1]="LEFT_JOIN_END",i[i.LEFT_CAP_START=-4]="LEFT_CAP_START",i[i.LEFT_CAP_END=-5]="LEFT_CAP_END",i[i.RIGHT_JOIN_START=2]="RIGHT_JOIN_START",i[i.RIGHT_JOIN_END=1]="RIGHT_JOIN_END",i[i.RIGHT_CAP_START=4]="RIGHT_CAP_START",i[i.RIGHT_CAP_END=5]="RIGHT_CAP_END"})(I||(I={}));class la extends Gt{constructor(e){super(e,pr),this._configuration=new _,this.vertexAttributeLocations=$t,this.produces=new Map([[V.OPAQUE_MATERIAL,t=>Fi(t)||ce(t)&&this.parameters.renderOccluded===re.OccludeAndTransparentStencil],[V.OPAQUE_MATERIAL_WITHOUT_NORMALS,t=>Ui(t)],[V.OCCLUDER_MATERIAL,t=>ot(t)&&this.parameters.renderOccluded===re.OccludeAndTransparentStencil],[V.TRANSPARENT_OCCLUDER_MATERIAL,t=>ot(t)&&this.parameters.renderOccluded===re.OccludeAndTransparentStencil],[V.TRANSPARENT_MATERIAL,t=>ce(t)&&this.parameters.writeDepth&&this.parameters.renderOccluded!==re.OccludeAndTransparentStencil],[V.TRANSPARENT_MATERIAL_WITHOUT_DEPTH,t=>ce(t)&&!this.parameters.writeDepth&&this.parameters.renderOccluded!==re.OccludeAndTransparentStencil],[V.DRAPED_MATERIAL,t=>Wi(t)]])}getConfiguration(e,t){this._configuration.output=e,this._configuration.oitPass=t.oitPass,this._configuration.draped=t.slot===V.DRAPED_MATERIAL;const r=this.parameters.stipplePattern!=null&&e!==se.Highlight;return this._configuration.stippleEnabled=r,this._configuration.stippleOffColorEnabled=r&&this.parameters.stippleOffColor!=null,this._configuration.stipplePreferContinuous=r&&this.parameters.stipplePreferContinuous,this._configuration.hasSlicePlane=this.parameters.hasSlicePlane,this._configuration.roundJoins=this.parameters.join==="round",this._configuration.capType=this.parameters.cap,this._configuration.applyMarkerOffset=this.parameters.markerParameters!=null&&hr(this.parameters.markerParameters),this._configuration.hasPolygonOffset=this.parameters.hasPolygonOffset,this._configuration.writeDepth=this.parameters.writeDepth,this._configuration.vvSize=!!this.parameters.vvSize,this._configuration.vvColor=!!this.parameters.vvColor,this._configuration.vvOpacity=!!this.parameters.vvOpacity,this._configuration.innerColorEnabled=this.parameters.innerWidth>0&&this.parameters.innerColor!=null,this._configuration.falloffEnabled=this.parameters.falloff>0,this._configuration.hasOccludees=t.hasOccludees,this._configuration.occluder=this.parameters.renderOccluded===re.OccludeAndTransparentStencil,this._configuration.terrainDepthTest=t.terrainDepthTest&&ce(e),this._configuration.cullAboveTerrain=t.cullAboveTerrain,this._configuration.wireframe=this.parameters.wireframe,this._configuration}get visible(){var e;return this.parameters.color[3]>=pe||this.parameters.stipplePattern!=null&&(((e=this.parameters.stippleOffColor)==null?void 0:e[3])??0)>pe}intersectDraped({attributes:e,screenToWorldRatio:t},r,s,a,h,d){if(!s.options.selectionMode)return;const n=e.get(l.SIZE);let c=this.parameters.width;if(this.parameters.vvSize){const y=e.get(l.SIZEFEATUREATTRIBUTE).data[0];c*=xe(this.parameters.vvSize.offset[0]+y*this.parameters.vvSize.factor[0],this.parameters.vvSize.minSize[0],this.parameters.vvSize.maxSize[0])}else n&&(c*=n.data[0]);const p=a[0],b=a[1],T=(c/2+4)*t;let E=Number.MAX_VALUE,z=0;const A=e.get(l.POSITION).data,j=Ue(this.parameters,e)?A.length-2:A.length-5;for(let y=0;y<j;y+=3){const S=A[y],$=A[y+1],g=(y+3)%A.length,m=p-S,D=b-$,u=A[g]-S,G=A[g+1]-$,L=xe((u*m+G*D)/(u*u+G*G),0,1),ie=u*L-m,x=G*L-D,X=ie*ie+x*x;X<E&&(E=X,z=y/3)}E<T*T&&h(d.dist,d.normal,z,!1)}intersect(e,t,r,s,a,h){if(!r.options.selectionMode||!e.visible)return;if(!Oi(t))return void Ft.getLogger("esri.views.3d.webgl-engine.materials.RibbonLineMaterial").error("intersection assumes a translation-only matrix");const d=e.attributes,n=d.get(l.POSITION).data;let c=this.parameters.width;if(this.parameters.vvSize){const S=d.get(l.SIZEFEATUREATTRIBUTE).data[0];c*=xe(this.parameters.vvSize.offset[0]+S*this.parameters.vvSize.factor[0],this.parameters.vvSize.minSize[0],this.parameters.vvSize.maxSize[0])}else d.has(l.SIZE)&&(c*=d.get(l.SIZE).data[0]);const p=r.camera,b=mr;Pi(b,r.point);const T=c*p.pixelRatio/2+4*p.pixelRatio;k(le[0],b[0]-T,b[1]+T,0),k(le[1],b[0]+T,b[1]+T,0),k(le[2],b[0]+T,b[1]-T,0),k(le[3],b[0]-T,b[1]-T,0);for(let S=0;S<4;S++)if(!p.unprojectFromRenderScreen(le[S],J[S]))return;Se(p.eye,J[0],J[1],Ie),Se(p.eye,J[1],J[2],we),Se(p.eye,J[2],J[3],Ne),Se(p.eye,J[3],J[0],ze);let E=Number.MAX_VALUE,z=0;const A=Ue(this.parameters,d)?n.length-2:n.length-5;for(let S=0;S<A;S+=3){C[0]=n[S]+t[12],C[1]=n[S+1]+t[13],C[2]=n[S+2]+t[14];const $=(S+3)%n.length;if(P[0]=n[$]+t[12],P[1]=n[$+1]+t[13],P[2]=n[$+2]+t[14],W(Ie,C)<0&&W(Ie,P)<0||W(we,C)<0&&W(we,P)<0||W(Ne,C)<0&&W(Ne,P)<0||W(ze,C)<0&&W(ze,P)<0)continue;if(p.projectToRenderScreen(C,q),p.projectToRenderScreen(P,K),q[2]<0&&K[2]>0){Le(M,C,P);const m=p.frustum,D=-W(m[ge.NEAR],C)/Qe(M,st(m[ge.NEAR]));De(M,M,D),ye(C,C,M),p.projectToRenderScreen(C,q)}else if(q[2]>0&&K[2]<0){Le(M,P,C);const m=p.frustum,D=-W(m[ge.NEAR],P)/Qe(M,st(m[ge.NEAR]));De(M,M,D),ye(P,P,M),p.projectToRenderScreen(P,K)}else if(q[2]<0&&K[2]<0)continue;q[2]=0,K[2]=0;const g=Ni(Ce(q,K,ft),b);g<E&&(E=g,Z(mt,C),Z(ut,P),z=S/3)}const j=r.rayBegin,y=r.rayEnd;if(E<T*T){let S=Number.MAX_VALUE;if(zi(Ce(mt,ut,ft),Ce(j,y,ur),Q)){Le(Q,Q,j);const $=Bt(Q);De(Q,Q,1/$),S=$/We(j,y)}h(S,Q,z,!1)}}get _layout(){const e=Ai().vec3f(l.POSITION).vec3f(l.PREVPOSITION).vec3f(l.NEXTPOSITION).f32(l.SUBDIVISIONFACTOR).vec2f(l.UV0);return this.parameters.vvSize?e.f32(l.SIZEFEATUREATTRIBUTE):e.f32(l.SIZE),this.parameters.vvColor?e.f32(l.COLORFEATUREATTRIBUTE):e.vec4f(l.COLOR),this.parameters.vvOpacity&&e.f32(l.OPACITYFEATUREATTRIBUTE),Fe()&&e.vec4u8(l.OBJECTANDLAYERIDCOLOR),e}createBufferWriter(){return new dr(this._layout,this.parameters)}createGLMaterial(e){return new cr(e)}validateParameters(e){e.join!=="miter"&&(e.miterLimit=0),e.markerParameters!=null&&(e.markerScale=e.markerParameters.width/e.width)}}class cr extends _i{constructor(){super(...arguments),this._stipplePattern=null}dispose(){super.dispose(),this._stippleTextures.release(this._stipplePattern),this._stipplePattern=null}beginSlot(e){const t=this._material.parameters.stipplePattern;return this._stipplePattern!==t&&(this._material.setParameters({stippleTexture:this._stippleTextures.swap(t,this._stipplePattern)}),this._stipplePattern=t),this.getTechnique(lr,e)}}class pr extends bi{constructor(){super(...arguments),this.width=0,this.color=wi,this.join="miter",this.cap=te.BUTT,this.miterLimit=5,this.writeDepth=!0,this.hasPolygonOffset=!1,this.stippleTexture=null,this.stipplePreferContinuous=!0,this.markerParameters=null,this.markerScale=1,this.hasSlicePlane=!1,this.vvFastUpdate=!1,this.isClosed=!1,this.falloff=0,this.innerWidth=0,this.wireframe=!1}get transparent(){var e;return this.color[3]<1||this.stipplePattern!=null&&(((e=this.stippleOffColor)==null?void 0:e[3])??0)<1}}class dr{constructor(e,t){this.vertexBufferLayout=e,this._parameters=t,this.numJoinSubdivisions=0;const r=t.stipplePattern?1:0;switch(this._parameters.join){case"miter":case"bevel":this.numJoinSubdivisions=r;break;case"round":this.numJoinSubdivisions=ue+r}}_isClosed(e){return Ue(this._parameters,e)}allocate(e){return this.vertexBufferLayout.createBuffer(e)}elementCount(e){const r=e.get(l.POSITION).indices.length/2+1,s=this._isClosed(e);let a=s?2:2*2;return a+=((s?r:r-1)-(s?0:1))*(2*this.numJoinSubdivisions+4),a+=2,this._parameters.wireframe&&(a=2+4*(a-2)),a}write(e,t,r,s,a,h){var He,Je,Ge;const d=fr,n=vr,c=gr,p=r.get(l.POSITION),b=p.indices,T=p.data.length/3,E=(He=r.get(l.DISTANCETOSTART))==null?void 0:He.data;b&&b.length!==2*(T-1)&&console.warn("RibbonLineMaterial does not support indices");const z=((Je=r.get(l.SIZEFEATUREATTRIBUTE))==null?void 0:Je.data[0])??((Ge=r.get(l.SIZE))==null?void 0:Ge.data[0])??1;let A=[1,1,1,1],j=0;const y=this.vertexBufferLayout.fields.has(l.COLORFEATUREATTRIBUTE);y?j=r.get(l.COLORFEATUREATTRIBUTE).data[0]:r.has(l.COLOR)&&(A=r.get(l.COLOR).data);const S=this.vertexBufferLayout.fields.has(l.OPACITYFEATUREATTRIBUTE),$=S?r.get(l.OPACITYFEATUREATTRIBUTE).data[0]:0,g=new Float32Array(a.buffer),m=Fe()?new Uint8Array(a.buffer):null,D=this.vertexBufferLayout.stride/4;let u=h*D;const G=u;let L=0;const ie=E?(O,U,H)=>L=E[H]:(O,U,H)=>L+=We(O,U),x=(O,U,H,ne,fe,It,wt)=>{if(g[u++]=U[0],g[u++]=U[1],g[u++]=U[2],g[u++]=O[0],g[u++]=O[1],g[u++]=O[2],g[u++]=H[0],g[u++]=H[1],g[u++]=H[2],g[u++]=ne,g[u++]=wt,g[u++]=fe,g[u++]=z,y)g[u++]=j;else{const ve=Math.min(4*It,A.length-4);g[u++]=A[ve],g[u++]=A[ve+1],g[u++]=A[ve+2],g[u++]=A[ve+3]}S&&(g[u++]=$),Fe()&&(s&&(m[4*u]=s[0],m[4*u+1]=s[1],m[4*u+2]=s[2],m[4*u+3]=s[3]),u++)};u+=D,k(n,p.data[0],p.data[1],p.data[2]),e&&B(n,n,e);const X=this._isClosed(r);if(X){const O=p.data.length-3;k(d,p.data[O],p.data[O+1],p.data[O+2]),e&&B(d,d,e)}else k(c,p.data[3],p.data[4],p.data[5]),e&&B(c,c,e),x(n,n,c,1,I.LEFT_CAP_START,0,0),x(n,n,c,1,I.RIGHT_CAP_START,0,0),Z(d,n),Z(n,c);const Ee=X?0:1,oe=X?T:T-1;for(let O=Ee;O<oe;O++){const U=(O+1)%T*3;k(c,p.data[U],p.data[U+1],p.data[U+2]),e&&B(c,c,e),ie(d,n,O),x(d,n,c,0,I.LEFT_JOIN_END,O,L),x(d,n,c,0,I.RIGHT_JOIN_END,O,L);const H=this.numJoinSubdivisions;for(let ne=0;ne<H;++ne){const fe=(ne+1)/(H+1);x(d,n,c,fe,I.LEFT_JOIN_END,O,L),x(d,n,c,fe,I.RIGHT_JOIN_END,O,L)}x(d,n,c,1,I.LEFT_JOIN_START,O,L),x(d,n,c,1,I.RIGHT_JOIN_START,O,L),Z(d,n),Z(n,c)}X?(k(c,p.data[3],p.data[4],p.data[5]),e&&B(c,c,e),L=ie(d,n,oe),x(d,n,c,0,I.LEFT_JOIN_END,Ee,L),x(d,n,c,0,I.RIGHT_JOIN_END,Ee,L)):(L=ie(d,n,oe),x(d,n,n,0,I.LEFT_CAP_END,oe,L),x(d,n,n,0,I.RIGHT_CAP_END,oe,L)),$e(g,G+D,g,G,D),u=$e(g,u-D,g,u,D),this._parameters.wireframe&&this._addWireframeVertices(a,G,u,D)}_addWireframeVertices(e,t,r,s){const a=new Float32Array(e.buffer,r*Float32Array.BYTES_PER_ELEMENT),h=new Float32Array(e.buffer,t*Float32Array.BYTES_PER_ELEMENT,r-t);let d=0;const n=c=>d=$e(h,c,a,d,s);for(let c=0;c<h.length-1;c+=2*s)n(c),n(c+2*s),n(c+1*s),n(c+2*s),n(c+1*s),n(c+3*s)}}function $e(i,e,t,r,s){for(let a=0;a<s;a++)t[r++]=i[e++];return r}function Ue(i,e){return i.isClosed?e.get(l.POSITION).indices.length>2:!1}function hr(i){return i.anchor===me.Tip&&i.hideOnShortSegments&&i.placement==="begin-end"&&i.worldSpace}const C=R(),P=R(),M=R(),Q=R(),mr=R(),q=ae(),K=ae(),mt=R(),ut=R(),ft=_t(),ur=_t(),fr=R(),vr=R(),gr=R(),le=[ae(),ae(),ae(),ae()],J=[R(),R(),R(),R()],Ie=Ae(),we=Ae(),Ne=Ae(),ze=Ae(),Sr=Object.freeze(Object.defineProperty({__proto__:null,build:Pt,ribbonlineNumRoundJoinSubdivisions:ue},Symbol.toStringTag,{value:"Module"}));export{Kr as A,Oe as C,la as W,ta as a,me as b,Xi as c,xt as d,N as e,te as f,na as g,ra as l,he as m,or as n,sr as p,ee as s,Qi as t,sa as u,oa as w};
