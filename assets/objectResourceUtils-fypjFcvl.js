...
}`)}}const sl=Dr(1,1,0,1),ll=Dr(1,0,1,1);function cl(t){t.fragment.uniforms.add(new K("depthTexture",(e,r)=>r.mainDepth)),t.fragment.constants.add("occludedHighlightFlag","vec4",sl).add("unoccludedHighlightFlag","vec4",ll),t.fragment.code.add(s`void outputHighlight() {
