import{h as O}from"./Color-VJEMvW-n.js";import{aO as F}from"./Accessor-BmwT4B0c.js";import{u as x}from"./screenUtils-_ZIvrt5o.js";import{u as $,r as f}from"./vec4f64-o2zAXfmz.js";import{o as P}from"./floatRGBA-Cb__GiDF.js";import{b as E,t as I}from"./NormalAttribute.glsl-0GHNIsQf.js";import{i as y,n as T,b as M,c as g,o as S,a as v,e as p,t as L}from"./Matrix3PassUniform-uCCQMnlP.js";import{t as h}from"./RgbaFloatEncoding.glsl-_io2eW3M.js";import{o as b}from"./Float4DrawUniform-Db0CLl_z.js";import{n as t,t as V}from"./glsl-BH37Aalp.js";import{a as N}from"./BindType-BBwFZqyN.js";import{e as s}from"./VertexAttribute-Cq4MnHjR.js";import{t as C,c as A}from"./Matrix3DrawUniform-DD7AqlIc.js";function R(o){return o.type==="fill"}function W(o){return o.type==="extrude"}var m;(function(o){o[o.TRANSPARENT=0]="TRANSPARENT",o[o.OPAQUE=1]="OPAQUE"})(m||(m={}));class z extends y{constructor(r,e){super(r,"int",N.Draw,(l,a,d)=>l.setUniform1i(r,e(a,d)))}}var i;(function(o){o[o.Uniform=0]="Uniform",o[o.Varying=1]="Varying",o[o.COUNT=2]="COUNT"})(i||(i={}));const u=429496.7296;function uo(o,r){P(o/u*.5+.5,r)}function xo(o,r){switch(r.componentData){case i.Varying:return U(o,r);case i.Uniform:return D(o,r);case i.COUNT:return;default:F(r.componentData)}}function U(o,r){const{vertex:e,fragment:l}=o;e.include(h),e.uniforms.add(new M("componentColorTex",d=>d.componentParameters.texture.texture)),o.attributes.add(s.COMPONENTINDEX,"float"),o.varyings.add("vExternalColorMixMode","mediump float"),o.varyings.add("vExternalColor","vec4");const a=r.output===T.ObjectAndLayerIdColor;a&&o.varyings.add("vObjectAndLayerIdColor","vec4"),o.include(E),e.constants.add("stride","float",g()?3:2),e.code.add(t`vec2 getComponentTextureCoordinates(float componentIndex, float typeOffset) {
...
return externalColor;
}`);const a=r.output===T.ObjectAndLayerIdColor;l.uniforms.add(new z("externalColorMixMode",d=>d.componentParameters.externalColorMixMode)).code.add(t`
  ...
  `)}function vo(o,r){const e=o.vertex;e.include(h),o.include(I,r);const{silhouette:l,legacy:a,spherical:d}=r;e.uniforms.add(new M("componentDataTex",n=>n.componentDataTexture)),o.attributes.add(s.COMPONENTINDEX,"float"),e.constants.add("lineWidthFractionFactor","float",8),e.constants.add("extensionLengthOffset","float",128),e.code.add(t`
